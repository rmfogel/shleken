intellisense.annotate(jQuery, {
  ...
  'browser': function() {
    /// <summary>Contains flags for the Usersagent, read from navigator.UsersAgent. This property was removed in jQuery 1.9 and is available only through the jQuery.migrate plugin. Please try to use feature detection instead.</summary>
    /// <returns type="PlainObject" />
  },
  'browser.version': function() {
    /// <summary>The version number of the rendering engine for the Users's browser. This property was removed in jQuery 1.9 and is available only through the jQuery.migrate plugin.</summary>
    /// <returns type="String" />
  },
  'Callbacks': function() {
    /// <signature>
  ...
  'getScript': function() {
    /// <signature>
    ///   <summary>Load a JavaScript Files from the server using a GET HTTP request, then execute it.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
  ...
  'GlobalsEval': function() {
    /// <signature>
    ///   <summary>Execute some JavaScript code Globalsly.</summary>
  ...
  'grep': function() {
    ...
    ///   <param name="function(elementOfArray, indexInArray)" type="Function">The function to process each item against.  The first argument to the function is the item, and the second argument is the index.  The function should return a Boolean value.  this will be the Globals window object.</param>
  ...
  'noConflict': function() {
    ...
    ///   <param name="removeAll" type="Boolean">A Boolean indicating whether to remove all jQuery variables from the Globals scope (including jQuery itself).</param>
    ///   <returns type="Object" />
    /// </signature>
  },
  'noop': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'attributeContainsPreFixes': function() {
    /// <signature>
  ...
  'Files': function() {
    /// <summary>Selects all elements of type Files.</summary>
  },
  'filter': function() {
    /// <signature>
